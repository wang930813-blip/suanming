<?php /* Smarty version 2.6.25, created on 2025-12-05 22:00:56
  ...
  <body>
    ...
    <div class="order-info">
      <div class="order-info__left">
        <span class="order-info__left-price">限时优惠￥<?php echo $this->_tpl_vars['money']; ?>
</span
...
<a class="pay_wx" data-method="Wechatpay3" target="_self" href="/?ct=pay&ac=go&oid=<?php echo $this->_tpl_vars['oid']; ?>
&type=1">微信支付</a>
 <?php endif; ?>
<?php if ($this->_tpl_vars['sys_pay_type'] == 0 || $this->_tpl_vars['sys_pay_type'] == 2 || $this->_tpl_vars['sys_pay_type'] == 3): ?>
<a class="pay_zfb" data-method="Alipay2" target="_self" href="/?ct=pay&ac=go&oid=<?php echo $this->_tpl_vars['oid']; ?>
&type=2">支付宝</a>
<?php endif; ?>

<?php if ($this->_tpl_vars['sys_pay_type'] == 0 || $this->_tpl_vars['sys_pay_type'] == 4): ?>
<a class="pay_wx" data-method="Wechatpay3" target="_self" href="/?ct=pay&ac=pay_go&oid=<?php echo $this->_tpl_vars['oid']; ?>
&type=wxpay">微信支付</a>
<?php endif; ?>
      </div>
