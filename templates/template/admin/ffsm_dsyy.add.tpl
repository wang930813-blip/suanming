                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-block">
                        <div class="layui-input-inline" style="width: 400px;">
                            <input type='text' name='images' id='images' value='' placeholder="请输入图片地址或点击上传" class="layui-input" <{if ($_submit_validate[$field].3=='all' || $_submit_validate[$field].3=='insert') && $_submit_validate[$field].1=='notempty'}>lay-verify="required"<{/if}> />
                        </div>
                        ...
                        <div style="margin-top: 10px;">
                            <img id="imagePreview" src="" style="max-width: 300px; max-height: 200px; display:none;" alt="图片预览">
                        </div>
                    </div>
                </div>
