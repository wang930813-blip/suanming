	...
	<div class="jb_content">
		...
		<div class="jbc_gezi">
			...
			<div class="jl_words left">
				<span><span style="color:#f2ac65"><{if $return.xm_arr.xing2}><{$return.xm_arr.xing1}><{else}>&nbsp;<{/if}></span></span><span><{if $return.xm_arr.xing2}><{$return.xm_arr.xing2}><{else}><{$return.xm_arr.xing1}><{/if}></span><span><{$return.xm_arr.ming1}></span><span><{if $return.xm_arr.ming2}><{$return.xm_arr.ming2}><{else}>&nbsp; <{/if}></span>
			</div>
...
<div class="jieming_box">
	...
	<div class="jb_bzmp">
	<p class="words">
			你的喜用神为:<b style="color: #ff4632"><{$return.data.xiyongshen.data.xishen}></b>
		</p>
		<div class="jb_bzmp_bottom">
