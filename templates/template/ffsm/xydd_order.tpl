...
<html lang="en">
 <head> 
  <meta charset="utf-8" /> 
  <title>祈福明灯，孔明灯，许愿广场，在线专业测试-<{$zhanming}></title> 
...
<{if $gundong}><div class="alert-marquee" id="alertMarquee"><p class="inner"><{$gundong}></p></div><{/if}>
      <div class="banner">
       <div class="lantern">
        <div class="lantern-on">
         <img src="/statics/ffsm/xydd/images/light/2.jpg" alt="" />
        </div>
       </div>
      ...
      <section>
       ...
       <div class="m-form" id="m-form1">
        ...
        <div class="f-box">
         <ul class="form">
          ...
          <li class="clear">
           ...
           <div class="auto">
            <input type="text" id="birthday" data-input-id="b_input" class="Js_date" data-type="0" value="请选择" placeholder="请选择日期" data-toid-hour="birthday"   data-date="2024-1-1" readonly="" placeholder="请选择(必填)" />
           </div></li>
          <li class="textarea">
        ...
        <div class="show-square">
         <p>
          <!-- react-text: 23 --><lang>在许愿广场显示：</lang>
      ...
      <div class="new-comment mai_d">
       <h3>◆ <lang>用户评论</lang> ◆</h3>
       <div class="marquee-wrapper">
        <ul class="comment-list info-list-box" >
         <li><p class="user" lang>订单号：KHFZOK***TIO76 女 25岁</p><p class="detail" lang>2024要高考了，点一盏光明灯和文昌灯，祈求能考上心仪的大学！</p></li>
         <li><p class="user" lang>订单号：KHFZOK***YUR85 男 34岁</p><p class="detail" lang>奶奶是我最爱的人！所以除了准备为她摆寿宴之外，特地来为她80大寿点一盏添寿灯和生辰灯，祝愿她平安幸福，长命百岁。</p></li>
         <li><p class="user" lang>订单号：KHFZOK***ERT70 女 27岁</p><p class="detail" lang>都大学毕业好几年了，始终都没谈过恋爱，点了桃花灯感觉好有用，不知道是不是心理暗示作用，点了1一个月不到就遇见心仪的男生了，最重要的是，他先追的我！</p></li>
         <li><p class="user" lang>订单号：KHFZOK***ACL22 女 26岁</p><p class="detail" lang>我就是典型的颜值不够，衣着打扮、行为举止来凑。男生的综合评价分跟这个测试结果差不多吧！</p></li>
         <li><p class="user" lang>订单号：KHFZOK***FTH45 女 22岁</p><p class="detail" lang>对自己的评价一直不够高，可能因为我是完美主义吧，这个影响了我的自信，所以总是不能很自如地展现自我魅力。估计我在两性关系上，就这一个bug了~</p></li>
         <li><p class="user" lang>订单号：KHFZOK***REG34 男 30岁</p><p class="detail" lang>这个测试还挺有意思的，比较客观地对自己进行了评价，比从朋友那里求证要好多了，毕竟大家都会说客套话。</p></li>
         <li><p class="user" lang>订单号：KHFZOK***JJF90 男 21岁 </p><p class="detail" lang>不高兴……果然测试结果的魅力不够高，看来从各个方面都要努力提升啊，否则感觉脱单无望了~</p></li>
         <li><p class="user" lang>订单号：KHFZOK***FDG65 男 25岁</p><p class="detail" lang>生日许了三个愿望，点了一盏生辰灯，来年检验我的愿望是否都能心想事成。</p></li>
         <li><p class="user" lang>订单号：KHFZOK***ETR 女 29岁</p><p class="detail" lang>新公司开业，体会做老板不易！点个招财灯，不求发大财，只求公司可以稳定发展正常运转，可以按时给员工发工资，就能令我感到安慰了</p></li>
         <li><p class="user" lang>订单号：KHFZOK***YUE64 男 28岁</p><p class="detail" lang>为新年点一盏事业灯，在同一家公司做了很多年，工资一直没涨，希望明年工作可以遇到更好的机会，令我有机会发挥，生活能有一个好的起色！</p></li>
        </ul>
       </div>
      </div>
