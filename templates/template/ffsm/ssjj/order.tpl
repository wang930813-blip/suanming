...
<link rel="stylesheet" href="/statics/ffsm/ssjj/css/style.css">

<link rel="stylesheet" href="/statics/ffsm/ssjj/css/font/iconfont.css">
<link href="/statics/ffsm/ssjj/css/wap.css" rel="stylesheet" type="text/css"/>
<link href="/statics/ffsm/ssjj/css/index.css" rel="stylesheet" type="text/css"/>
<link href="/statics/ffsm/ssjj/css/style.min.css" rel="stylesheet" type="text/css"/>
<script src="/statics/ffsm/ssjj/js/vue.min.js"></script>
<script src="statics/ffsm/public/js/require/require.min.js" data-main="/statics/ffsm/public/js/common.min.js?v=0817"></script>
<script src="/statics/ffsm/ssjj/js/jquery.min.js"></script>
<link rel="stylesheet" href="/statics/ffsm/ssjj/css/public.css">
<link rel="stylesheet" href="/statics/ffsm/ssjj/layui/css/layui.css">  
...
<body>
<script src="/statics/ffsm/ssjj/layui/layui.js"></script>
<div id="order">
<div class="public_header">
<a class="public_h_con" href="/?ac=ssjj">实时竞技</a><a href="javascript:void(0)" class="public_h_menu"<{if $nologin}>  onclick="layui.use('layer', function(){layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
location.href='?ac=userlogin&return_url=<{$return_url}>';
}});});"<{else}>:class="show" @click="chooseCoupon"<{/if}> ><img src="/statics/ffsm/ssjj/img/wddd.png" /></a></div>
<div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/ssjj/img/laba.png" /></span><p class="inner"><{$gundong}></p></div>
...
<div class="container pay" style="padding-bottom: 0;">
  <div class="wrap">
	...
	<{include file='./ffsm/ssjj/ss_icon.tpl'}>
	<div class="public_bg_color">
		<div class="center_bg">
			...
			<div class="im_info">
				...
				<img src="/statics/ffsm/ssjj/img/info_l_bg.png" alt="" class="bg5">
				</div>
				<div class="im_info_c">

					<div class="im_info_c_c">
				</br>
<p>苦练技术，经常氪金，却还是难升段位、连抽不中、逢人就被虐？竞技游戏，抓住欧皇时间，至关重要。解锁自身属性，知晓竞技值波动。“实时竞技”为你展示全天24小时的“精气神”数据及竞技值，高低好坏，一目了然。成为大神，就是现在！</p>

					</div>
			
				</div>
				<div class="im_info_r_bg">
				<img src="/statics/ffsm/ssjj/img/info_r_bg.png" alt="" class="bg5">	
				</div>
			</div>
	...
	<div class="public_bg_color J_testFixedShow" id="paytype">
		<div class="price">
		  <p class="tit1 left_l_bf">测算项目：实时竞技 【付费一次,可看前后6天】</p>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     <li><a href="?ac=ssjj"><i class="shouye_1"></i><p>测算首页</p></a></li>
     <li><a href="/?ac=member"><i class="wddd_1"></i><p>订单查询</p></a></li>
     <li><a href="?ac=ssjj"><em><i class="lijics_1"></i></em><p>重新测算</p></a></li>
...
<{include file='./ffsm/ssjj/footer.tpl'}>
