...
<a class="public_h_con" href="/?ac=ssjj">实时竞技</a><a href="javascript:void(0)" class="public_h_menu"<{if $nologin}>  onclick="layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
...
<{if $gundong}><div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/ssjj/img/laba.png" /></span><p class="inner"><{$gundong}></p></div><{/if}>
...
<div class="public_banner"  id="submit2">
	<img src="/statics/ffsm/ssjj/img/banner.jpg" alt="实时竞技"/>
</div>

<{include file='./ffsm/ssjj/ss_icon.tpl'}>

<div class="public_bg_from">
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=ssjj" name="login" method="post" onSubmit="return checkForm();">
		...
		<div class="form_bottom_txt">
			<span>已为<b>78815</b>人查看2022年实时竞技</span>
		</div>
	</form>
...
<p>在竞技值高的时候，更易提升段位、抽奖氪金，多利用“精气神”中的优势项，发挥身体控制力和欧皇运气，从而帮助自己连抽连中，快速突破段位，成为大神！</p></br>
...
<{include file='./ffsm/ssjj/footer_jg.tpl'}>
