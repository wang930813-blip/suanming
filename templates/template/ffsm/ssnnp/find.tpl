...
<html lang="en"><head>
  ...
  <link rel="stylesheet" href="/statics/ffsm/ssnnp/css/swiper.min.css">
  <link rel="stylesheet" href="/statics/ffsm/ssnnp/css/style.css">
  
  <link rel="shortcut icon" href="/statics/ffsm/favicon.ico"/>
  <link href="/statics/ffsm/ssnnp/css/page1.css" rel="stylesheet" type="text/css"/>
  ...
  <link rel="stylesheet" href="/statics/ffsm/ssnnp/css/font/iconfont.css">
...
<a class="public_h_home" href="/?ac=ssnnp"></a><a href="javascript:void(0)" class="public_h_menu"<{if $nologin}>  onclick="layui.use('layer', function(){layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
...
<div class="person_f">
	<div class="<{if $data.data.gender==1}>person_n_f<{else}>person_v_f<{/if}>">
      <div class="hd">
        <img src="<{if $data.data.gender==1}>/statics/ffsm/ssnnp/img/find_nan_toux.png<{else}>/statics/ffsm/ssnnp/img/find_nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name">姓名：<{$data.data.username}><span class="male"><img src="<{if $data.data.gender==1}>/statics/ffsm/ssnnp/img/male.png<{else}>/statics/ffsm/ssnnp/img/female.png<{/if}>"></span></p>
...
<div class="person_f">
	<div class="<{if $data.data.gender2==1}>person_n_f<{else}>person_v_f<{/if}>">
      <div class="hd">
        <img src="<{if $data.data.gender2==1}>/statics/ffsm/ssnnp/img/find_nan_toux.png<{else}>/statics/ffsm/ssnnp/img/find_nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name">姓名：<{$data.data.girl_username}><span class="male"><img src="<{if $data.data.gender2==1}>/statics/ffsm/ssnnp/img/male.png<{else}>/statics/ffsm/ssnnp/img/female.png<{/if}>"></span></p>
	...
	<div class="pipeizhi">
		<div class="pipeizhi_pipei">
			<div class="pipeizhi_tit">
				<span class="pipeizhi_tit_a"><img src="<{if $data.data.gender==1}>/statics/ffsm/ssnnp/img/male_c.png<{else}>/statics/ffsm/ssnnp/img/female_c.png<{/if}>"></span>
				<span class="pipeizhi_tit_b"><{$data.data.username}></span>
			</div>
			<div class="pipeizhi_tit">
				<span class="pipeizhi_tit_a2"><img src="/statics/ffsm/ssnnp/img/peidui.png"></span>
				<span class="pipeizhi_tit_c">配对指数</span>
			</div>
			<div class="pipeizhi_tit">
				<span class="pipeizhi_tit_a"><img src="<{if $data.data.gender2==1}>/statics/ffsm/ssnnp/img/male_c.png<{else}>/statics/ffsm/ssnnp/img/female_c.png<{/if}>"></span>
...
<script>
  ...
  <script src="/statics/ffsm/ssnnp/js/swiper.min.js"></script>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     <li><a href="?ac=ssnnp"><i class="shouye_1"></i><p>测算首页</p></a></li>
     <li><a href="/?ac=member"><i class="wddd_1"></i><p>订单查询</p></a></li>
     <li><a href="?ac=ssnnp"><em><i class="lijics_1"></i></em><p>继续测算</p></a></li>
