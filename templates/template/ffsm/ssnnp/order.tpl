...
<link href="/statics/ffsm/ssnnp/css/index.css" rel="stylesheet" type="text/css"/>
...
<div class="container pay" style="padding-bottom: 0;">
  <div class="wrap">
    <div class="person <{if $names.gender==1}>person_n<{else}>person_v<{/if}>">
      <div class="hd">
        <img src="<{if $names.gender==1}>/statics/ffsm/ssnnp/img/nan_toux.png<{else}>/statics/ffsm/ssnnp/img/nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name"><{$names.username}><span class="male"><img src="<{if $names.gender==1}>/statics/ffsm/ssnnp/img/male.png<{else}>/statics/ffsm/ssnnp/img/female.png<{/if}>"></span></p>
	...
	<div class="person <{if $names.gender2==1}>person_n<{else}>person_v<{/if}>">
      <div class="hd">
        <img src="<{if $names.gender2==1}>/statics/ffsm/ssnnp/img/nan_toux.png<{else}>/statics/ffsm/ssnnp/img/nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name"><{$names.girl_username}><span class="male"><img src="<{if $names.gender2==1}>/statics/ffsm/ssnnp/img/male.png<{else}>/statics/ffsm/ssnnp/img/female.png<{/if}>"></span></p>
	...
	<div class="public_bg_color">
			<div class="im_info_c" style="font-size: 0.3rem;">
					<p>真正的兄弟情，是介于友情与爱情之间的。你们的匹配度究竟如何呢？感情究竟有多深？</p>
<p>“实时兄弟情”为你展示双方全天24小时的“精气神”数据及匹配值，高低好坏，一目了然，辨别简单。解锁双方属性，知晓匹配状态。兄弟情义，更长更持久！</p>
				</div>
</div>
    
	<div class="public_bg_color J_testFixedShow" id="paytype">
		<div class="price">
		  <p class="tit1 left_l_bf">测算项目：实时兄弟情 【付费一次,可看前后6天】</p>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="?ac=ssnnp"><em><i class="lijics_1"></i></em><p>重新测算</p></a></li>
...
<{include file='./ffsm/ssnnp/footer.tpl'}>
