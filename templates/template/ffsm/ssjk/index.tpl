...
<a class="public_h_con" href="/?ac=ssjk">实时健康</a><a href="javascript:void(0)" class="public_h_menu"<{if $nologin}>  onclick="layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
...
<{if $gundong}><div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/ssjk/img/laba.png" /></span><p class="inner"><{$gundong}></p></div><{/if}>
...
<div class="public_banner"  id="submit2">
	<img src="/statics/ffsm/ssjk/img/banner.jpg" alt="实时健康"/>
</div>

<{include file='./ffsm/ssjk/ss_icon.tpl'}>

<div class="public_bg_from">
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=ssjk" name="login" method="post" onSubmit="return checkForm();">
		...
		<div class="form_bottom_txt">
			<span>已为<b>96118</b>人查看2022年实时健康</span>
		</div>
	</form>
...
<p>在健康值高的时候，更易提升身体素质、补充营养，多利用“精气神”中的优势项，去进行锻炼和进补，从而帮助你正确运用时间、精力，轻松获得更加健康的体质。</p></br>
...
<{include file='./ffsm/ssjk/footer_jg.tpl'}>
