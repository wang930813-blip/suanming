...
<link rel="stylesheet" href="/statics/ffsm/ssjk/css/style.css">

<link rel="stylesheet" href="/statics/ffsm/ssjk/css/font/iconfont.css">
<link href="/statics/ffsm/ssjk/css/wap.css" rel="stylesheet" type="text/css"/>
<link href="/statics/ffsm/ssjk/css/index.css" rel="stylesheet" type="text/css"/>
<link href="/statics/ffsm/ssjk/css/style.min.css" rel="stylesheet" type="text/css"/>
<script src="/statics/ffsm/ssjk/js/vue.min.js"></script>
<script src="statics/ffsm/public/js/require/require.min.js" data-main="/statics/ffsm/public/js/common.min.js?v=0817"></script>
<script src="/statics/ffsm/ssjk/js/jquery.min.js"></script>
<link rel="stylesheet" href="/statics/ffsm/ssjk/css/public.css">
<link rel="stylesheet" href="/statics/ffsm/ssjk/layui/css/layui.css">  
...
<body>
<script src="/statics/ffsm/ssjk/layui/layui.js"></script>
<div id="order">
<div class="public_header">
<a class="public_h_con" href="/?ac=ssjk">实时健康</a><a href="javascript:void(0)" class="public_h_menu"<{if $nologin}>  onclick="layui.use('layer', function(){layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
location.href='?ac=userlogin&return_url=<{$return_url}>';
}});});"<{else}>:class="show" @click="chooseCoupon"<{/if}> ><img src="/statics/ffsm/ssjk/img/wddd.png" /></a></div>
<div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/ssjk/img/laba.png" /></span><p class="inner"><{$gundong}></p></div>
...
<div class="container pay" style="padding-bottom: 0;">
  <div class="wrap">
	...
	<{include file='./ffsm/ssjk/ss_icon.tpl'}>
	<div class="public_bg_color">
		<div class="center_bg">
			...
			<div class="im_info">
				...
				<img src="/statics/ffsm/ssjk/img/info_l_bg.png" alt="" class="bg5">
				</div>
				<div class="im_info_c">
				
					<div class="im_info_c_c">
				</br>
<p>活的通透的人才知道，身体是最重要的。莫因错付精力，白白误了健康。解锁自身属性，抓住健康时机。“实时健康”为你展示全天24小时的“精气神”数据及健康值，高低好坏，一目了然，辨别简单。尊重科学，顺应天道，享受岁月安好！</p>
					</div>
			
				</div>
				<div class="im_info_r_bg">
				<img src="/statics/ffsm/ssjk/img/info_r_bg.png" alt="" class="bg5">	
				</div>
			</div>
	...
	<div class="public_bg_color J_testFixedShow" id="paytype">
		<div class="price">
		  <p class="tit1 left_l_bf">测算项目：实时健康 【付费一次,可看前后6天】</p>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     <li><a href="?ac=ssjk"><i class="shouye_1"></i><p>测算首页</p></a></li>
     <li><a href="/?ac=member"><i class="wddd_1"></i><p>订单查询</p></a></li>
     <li><a href="?ac=ssjk"><em><i class="lijics_1"></i></em><p>重新测算</p></a></li>
...
<{include file='./ffsm/ssjk/footer.tpl'}>
