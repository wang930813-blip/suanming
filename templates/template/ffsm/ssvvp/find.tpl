...
<html lang="en"><head>
  ...
  <link rel="stylesheet" href="/statics/ffsm/ssvvp/css/swiper.min.css">
  <link rel="stylesheet" href="/statics/ffsm/ssvvp/css/style.css">
  
  <link rel="shortcut icon" href="/statics/ffsm/favicon.ico"/>
  <link href="/statics/ffsm/ssvvp/css/page1.css" rel="stylesheet" type="text/css"/>
...
<div class="person_f">
	<div class="<{if $data.data.gender==1}>person_n_f<{else}>person_v_f<{/if}>">
      <div class="hd">
        <img src="<{if $data.data.gender==1}>/statics/ffsm/ssvvp/img/find_nan_toux.png<{else}>/statics/ffsm/ssvvp/img/find_nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name">姓名：<{$data.data.username}><span class="male"><img src="<{if $data.data.gender==1}>/statics/ffsm/ssvvp/img/male.png<{else}>/statics/ffsm/ssvvp/img/female.png<{/if}>"></span></p>
...
<div class="person_f">
	<div class="<{if $data.data.gender2==1}>person_n_f<{else}>person_v_f<{/if}>">
      <div class="hd">
        <img src="<{if $data.data.gender2==1}>/statics/ffsm/ssvvp/img/find_nan_toux.png<{else}>/statics/ffsm/ssvvp/img/find_nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name">姓名：<{$data.data.girl_username}><span class="male"><img src="<{if $data.data.gender2==1}>/statics/ffsm/ssvvp/img/male.png<{else}>/statics/ffsm/ssvvp/img/female.png<{/if}>"></span></p>
	...
	<div class="pipeizhi">
		<div class="pipeizhi_pipei">
			<div class="pipeizhi_tit">
				<span class="pipeizhi_tit_a"><img src="<{if $data.data.gender==1}>/statics/ffsm/ssvvp/img/male_c.png<{else}>/statics/ffsm/ssvvp/img/female_c.png<{/if}>"></span>
				<span class="pipeizhi_tit_b"><{$data.data.username}></span>
			</div>
			<div class="pipeizhi_tit">
				<span class="pipeizhi_tit_a2"><img src="/statics/ffsm/ssvvp/img/peidui.png"></span>
				<span class="pipeizhi_tit_c">配对指数</span>
			</div>
			<div class="pipeizhi_tit">
				<span class="pipeizhi_tit_a"><img src="<{if $data.data.gender2==1}>/statics/ffsm/ssvvp/img/male_c.png<{else}>/statics/ffsm/ssvvp/img/female_c.png<{/if}>"></span>
...
<script>
  ...
  <script src="/statics/ffsm/ssvvp/js/swiper.min.js"></script>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="?ac=ssvvp"><em><i class="lijics_1"></i></em><p>继续测算</p></a></li>
