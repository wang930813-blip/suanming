...
<link href="/statics/ffsm/sslg/css/index.css" rel="stylesheet" type="text/css"/>
...
<p>灵感，是命运的赐福，能否抓住，非常关键！莫因时机出现而不知，白白付出宝贵的精力和时间！解锁自身属性，知晓灵感值波动。“实时灵感”为你展示全天24小时的“精气神”数据及灵感值，一目了然，辨别简单，突破难关更加轻松！</p>
					</div>
	...
	<div class="public_bg_color J_testFixedShow" id="paytype">
		<div class="price">
		  <p class="tit1 left_l_bf">测算项目：实时灵感 【付费一次,可看前后6天】</p>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="?ac=sslg"><em><i class="lijics_1"></i></em><p>重新测算</p></a></li>
...
<{include file='./ffsm/sslg/footer.tpl'}>
