...
<html lang="en"><head>
  ...
  <link rel="stylesheet" href="/statics/ffsm/sscwy/css/swiper.min.css">
  <link rel="stylesheet" href="/statics/ffsm/sscwy/css/style.css">
  
  <link rel="shortcut icon" href="/statics/ffsm/favicon.ico"/>
  <link href="/statics/ffsm/sscwy/css/page1.css" rel="stylesheet" type="text/css"/>
  ...
  <link rel="stylesheet" href="/statics/ffsm/sscwy/css/font/iconfont.css">
...
<a class="public_h_home" href="/?ac=sscwy"></a><a href="javascript:void(0)" class="public_h_menu"<{if $nologin}>  onclick="layui.use('layer', function(){layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
location.href='?ac=userlogin&return_url=<{$return_url}>';
}});});"<{else}>:class="show" @click="chooseCoupon"<{/if}> >个人中心</a>
<div class="bg_rh"></div>
</div>
...
<div class="person_f">
	<div class="<{if $data.data.gender==1}>person_n_f<{else}>person_v_f<{/if}>">
      <div class="hd">
        <img src="<{if $data.data.gender==1}>/statics/ffsm/sscwy/img/find_nan_toux.png<{else}>/statics/ffsm/sscwy/img/find_nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name">姓名：<{$data.data.username}><span class="male"><img src="<{if $data.data.gender==1}>/statics/ffsm/sscwy/img/male.png<{else}>/statics/ffsm/sscwy/img/female.png<{/if}>"></span></p>
...
<div class="person_f">
	<div class="<{if $data.data.gender2==1}>person_n_f<{else}>person_v_f<{/if}>">
      <div class="hd">
        <img src="<{if $data.data.gender2==1}>/statics/ffsm/sscwy/img/find_nan_toux.png<{else}>/statics/ffsm/sscwy/img/find_nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name">姓名：<{$data.data.girl_username}><span class="male"><img src="<{if $data.data.gender2==1}>/statics/ffsm/sscwy/img/male.png<{else}>/statics/ffsm/sscwy/img/female.png<{/if}>"></span></p>
	...
	<div class="pipeizhi">
		<div class="pipeizhi_pipei">
			<div class="pipeizhi_tit">
				<span class="pipeizhi_tit_a"><img src="<{if $data.data.gender==1}>/statics/ffsm/sscwy/img/male_c.png<{else}>/statics/ffsm/sscwy/img/female_c.png<{/if}>"></span>
				<span class="pipeizhi_tit_b"><{$data.data.username}></span>
			</div>
			<div class="pipeizhi_tit">
				<span class="pipeizhi_tit_a2"><img src="/statics/ffsm/sscwy/img/peidui.png"></span>
				<span class="pipeizhi_tit_c">配对指数</span>
			</div>
			<div class="pipeizhi_tit">
				<span class="pipeizhi_tit_a"><img src="<{if $data.data.gender2==1}>/statics/ffsm/sscwy/img/male_c.png<{else}>/statics/ffsm/sscwy/img/female_c.png<{/if}>"></span>
				<span class="pipeizhi_tit_b"><{$data.data.girl_username}></span>
			</div>
		</div>
		<div class="pipeizhi_jd clearfix " data-percent="<{$ssysdata.arrt_one.date_jqs.th}>%">

			<div class="pipeizhi_jd-title"><span>匹配结合度</span></div>

			<div class="pipeizhi_jd-bar"></div>

			<div class="pipeizhi_jd-bar-percent"><{$ssysdata.arrt_one.date_jqs.th}>%</div>
...
<p>② 使用方法：
外遇率高时，一定要多加小心，提高警惕。在”精”数值显红时，多进行运动；”气”数值显红时，多与人结交；”神”数值显红时，多思考。可提升运势。</p>
				</div>
</div>
...
<script>
  ...
  <script src="/statics/ffsm/sscwy/js/swiper.min.js"></script>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     <li><a href="?ac=sscwy"><i class="shouye_1"></i><p>测算首页</p></a></li>
     <li><a href="/?ac=member"><i class="wddd_1"></i><p>订单查询</p></a></li>
     <li><a href="?ac=sscwy"><em><i class="lijics_1"></i></em><p>继续测算</p></a></li>
