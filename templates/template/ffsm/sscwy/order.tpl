...
<link href="/statics/ffsm/sscwy/css/index.css" rel="stylesheet" type="text/css"/>
...
<div class="container pay" style="padding-bottom: 0;">
  <div class="wrap">
    <div class="person <{if $names.gender==1}>person_n<{else}>person_v<{/if}>">
      <div class="hd">
        <img src="<{if $names.gender==1}>/statics/ffsm/sscwy/img/nan_toux.png<{else}>/statics/ffsm/sscwy/img/nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name"><{$names.username}><span class="male"><img src="<{if $names.gender==1}>/statics/ffsm/sscwy/img/male.png<{else}>/statics/ffsm/sscwy/img/female.png<{/if}>"></span></p>
	...
	<div class="person <{if $names.gender2==1}>person_n<{else}>person_v<{/if}>">
      <div class="hd">
        <img src="<{if $names.gender2==1}>/statics/ffsm/sscwy/img/nan_toux.png<{else}>/statics/ffsm/sscwy/img/nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name"><{$names.girl_username}><span class="male"><img src="<{if $names.gender2==1}>/statics/ffsm/sscwy/img/male.png<{else}>/statics/ffsm/sscwy/img/female.png<{/if}>"></span></p>
	...
	<div class="public_bg_color">
			<div class="im_info_c">
					<p>世上本没有轨，出的人多了，也便有了轨······ 莫因一时大意，盲目信任感情，最终落得满盘皆输！你们的忠诚度、魅力值究竟如何？TA是否对你忠心不二？</p> 
<p>感情，光靠经营是不够的！“实时查外遇”为你展示双方全天24小时的“精气神”数据及外遇率，高低好坏，一目了然。化身柯南，就从现在开始！</p> 
				</div>
</div>
    
	<div class="public_bg_color J_testFixedShow" id="paytype">
		<div class="price">
		  <p class="tit1 left_l_bf">测算项目：实时查外遇 【付费一次,可看前后6天】</p>
		  <div class="clearfix inner">
		  
			<div class="fl">
			  <span class="yh">限时优惠￥<{$money}>元</span>
			  <s class="gray"><lang>原价：</lang>￥56.00</s></div>
			<div class="fr">
			  <p>距优惠结束</p>
			  <p class="red">
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="?ac=sscwy"><em><i class="lijics_1"></i></em><p>重新测算</p></a></li>
...
<{include file='./ffsm/sscwy/footer.tpl'}>
