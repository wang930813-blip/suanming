    ...
    <section id="page-pay">
     <section data-reactroot="">
      ...
      <div class="main">
       <div class="tips">
        <p>
        <lang>已为19805241人进行点灯，99%以上的测试用户对财运有提升。点灯就能捉住致富机遇，轻松赚大钱</lang>
        </p>
       </div>
            ...
            <{/if}>
                ...
                <div class="right">
                    <div class="pay-radio"></div>
                        ...
                        <a class="alipay" target="_self" href="/?ct=pay&ac=paypal_go&oid=<{$oid}>">
                        <div class="auto">
                         <span class="pay-icon paypal"></span>
                            <span>paypal支付</span></div>
                        </a>
       ...
       <div class="pay-content">
        ...
        <div class="pay-middle">
         ...
         <div class="content-item">
          <h4>点灯的功效</h4>
          <div class="item-detail">
           <p><lang>当灯燃起时，它就长明在你心中，成为你的念力，激发你的潜力、智力以及感召力。只要你发愿向好，许愿灯就会在你心中形成光明磁场，<助你心想事成、万事如意、逢凶化吉。当越来越多人共同为一件事情祈祷，愿力会更强，能使灾难远去，天下太平！</lang></p>
          </div>
         </div>
         <div class="content-item">
          <h4>点的灯会供奉在哪？</h4>
          <div class="item-detail">
           <p><lang>点灯后，所有许愿灯将出现在【祈福灯广场】中，与众网友一起增强感应力，受到更多人的祝福。</lang></p>
          </div>
         </div>
        </div>
