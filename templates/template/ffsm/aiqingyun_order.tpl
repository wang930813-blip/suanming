...
<head>
<meta charset="UTF-8"/>
<title>2025爱情流年_爱情运势_姓名测试爱情_姓名爱情测试-<{$zhanming}></title>
...
<div class="main" id="main">
  ...
  <div class="cszhifu-box">
    <div class="fourth-tit J_testFixedShow">
      <span>测试项目：2026年爱情运势</span></div>
    <div class="jiagebox clearfix">
      <p class="plf">
        <span><lang>结缘价：</lang><{$money}>元</span>
        <em>（<lang>原价：</lang>168元）</em></p>
      <p class="prg">
        <span>距优惠结束</span>
    ...
    <div class="zffs-list">
      <ul class="clearfix">
		...
		<{if $payMethod.paypal}>
			  <li>
          <a href="/?ct=pay&ac=paypal_go&oid=<{$oid}>" target="_blank">
            <p class="plf">
              <span class="zf-paypal"></span>paypal支付</p>
            <p class="prg">
              <span>立即支付</span></p>
          </a>
        </li>
...
.ydgz p{color: #00b98d;font-size: 1.25rem;text-align: center;}
  ...
  <!--zf end-->
  <div class="box">
    <div class="sec-title">2025爱情综合运势</div>
  ...
  <div class="box">
    <div class="sec-title">2025爱情月份运势强弱</div>
    <div class="borbox J_payPopupShow">
      <div class="borline"></div>
      <div class="jieguo-txt">
