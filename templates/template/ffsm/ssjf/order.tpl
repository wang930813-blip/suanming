...
<link rel="stylesheet" href="/statics/ffsm/ssjf/css/style.css">

<link rel="stylesheet" href="/statics/ffsm/ssjf/css/font/iconfont.css">
<link href="/statics/ffsm/ssjf/css/wap.css" rel="stylesheet" type="text/css"/>
<link href="/statics/ffsm/ssjf/css/index.css" rel="stylesheet" type="text/css"/>
<link href="/statics/ffsm/ssjf/css/style.min.css" rel="stylesheet" type="text/css"/>
<script src="/statics/ffsm/ssjf/js/vue.min.js"></script>
<script src="statics/ffsm/public/js/require/require.min.js" data-main="/statics/ffsm/public/js/common.min.js?v=0817"></script>
<script src="/statics/ffsm/ssjf/js/jquery.min.js"></script>
<link rel="stylesheet" href="/statics/ffsm/ssjf/css/public.css">
<link rel="stylesheet" href="/statics/ffsm/ssjf/layui/css/layui.css">  
...
<body>
<script src="/statics/ffsm/ssjf/layui/layui.js"></script>
<div id="order">
<div class="public_header">
<a class="public_h_con" href="/?ac=ssjf">实时减肥</a><a href="javascript:void(0)" class="public_h_menu"<{if $nologin}>  onclick="layui.use('layer', function(){layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
location.href='?ac=userlogin&return_url=<{$return_url}>';
}});});"<{else}>:class="show" @click="chooseCoupon"<{/if}> ><img src="/statics/ffsm/ssjf/img/wddd.png" /></a></div>
<div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/ssjf/img/laba.png" /></span><p class="inner"><{$gundong}></p></div>
...
<div class="container pay" style="padding-bottom: 0;">
  <div class="wrap">
	...
	<{include file='./ffsm/ssjf/ss_icon.tpl'}>
	<div class="public_bg_color">
		<div class="center_bg">
			...
			<div class="im_info">
				...
				<img src="/statics/ffsm/ssjf/img/info_l_bg.png" alt="" class="bg5">
				</div>
				<div class="im_info_c">
				
					<div class="im_info_c_c">
				</br>
<p>最动听的三个字，不是”我爱你”，而是”你瘦了”。莫因错过了最佳减肥时机，白白挨饿、流汗！ “实时减肥”为你展示全天24小时的“精气神”数据及减肥值，高低好坏，一目了然，辨别简单。合理调节后，你会发现：不节食就能瘦、不反弹，其实很简单！</p>
					</div>
			
				</div>
				<div class="im_info_r_bg">
				<img src="/statics/ffsm/ssjf/img/info_r_bg.png" alt="" class="bg5">	
				</div>
			</div>
	...
	<div class="public_bg_color J_testFixedShow" id="paytype">
		<div class="price">
		  <p class="tit1 left_l_bf">测算项目：实时减肥 【付费一次,可看前后6天】</p>
		  <div class="clearfix inner">
		  
			<div class="fl">
			  <span class="yh">限时优惠￥<{$money}>元</span>
			  <s class="gray"><lang>原价：</lang>￥28.00</s></div>
			<div class="fr">
			  <p>距优惠结束</p>
			  <p class="red">
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     <li><a href="?ac=ssjf"><i class="shouye_1"></i><p>测算首页</p></a></li>
     <li><a href="/?ac=member"><i class="wddd_1"></i><p>订单查询</p></a></li>
     <li><a href="?ac=ssjf"><em><i class="lijics_1"></i></em><p>重新测算</p></a></li>
...
function dcwjalert(){
 ...
 <{/foreach}> 
	...
	<{foreach key =k3 item=i3 from=$my_order}>
		...
		setTimeout(function(){
		layui.use('layer', function(){
			layer.msg('亲！您已有测算的订单。<br>请点击右上角【个人中心】进行查看。', {
			time: 20000, 
			btn: ['知道了'],
			id: 'LAY_order',
			anim: 2,
...
<{include file='./ffsm/ssjf/footer.tpl'}>
