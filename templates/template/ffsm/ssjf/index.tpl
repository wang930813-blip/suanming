...
<a class="public_h_con" href="/?ac=ssjf">实时减肥</a><a href="javascript:void(0)" class="public_h_menu"<{if $nologin}>  onclick="layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
...
<{if $gundong}><div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/ssjf/img/laba.png" /></span><p class="inner"><{$gundong}></p></div><{/if}>
...
<div class="public_banner"  id="submit2">
	<img src="/statics/ffsm/ssjf/img/banner.jpg" alt="实时减肥"/>
</div>

<{include file='./ffsm/ssjf/ss_icon.tpl'}>

<div class="public_bg_from">
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=ssjf" name="login" method="post" onSubmit="return checkForm();">
		...
		<div class="form_bottom_txt">
			<span>已为<b>51315</b>人查看2022年实时减肥</span>
		</div>
	</form>
...
<p>在减肥值高的时候，更易进行减肥行动，多利用“精气神”中的优势项，有方向地去减肥，从而帮助您做到躺着也能减、体重不反弹，怎么吃都不会胖。</p></br>
...
<{include file='./ffsm/ssjf/footer_jg.tpl'}>
