...
<a class="public_h_con" href="/?ac=ssjs">实时健身</a><a href="javascript:void(0)" class="public_h_menu"<{if $nologin}>  onclick="layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
...
<{if $gundong}><div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/ssjs/img/laba.png" /></span><p class="inner"><{$gundong}></p></div><{/if}>
...
<div class="public_banner"  id="submit2">
	<img src="/statics/ffsm/ssjs/img/banner.jpg" alt="实时健身"/>
</div>

<{include file='./ffsm/ssjs/ss_icon.tpl'}>

<div class="public_bg_from">
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=ssjs" name="login" method="post" onSubmit="return checkForm();">
		...
		<div class="form_bottom_txt">
			<span>已为<b>95655</b>人查看2022年实时健身</span>
		</div>
	</form>
...
<p>在健身率高的时候，更易获得修型、健体的效果，多利用“精气神”中的优势项，进行锻炼，从而帮助你花最少的时间、流最少的汗，就能轻松修出诱人线条！</p></br>
