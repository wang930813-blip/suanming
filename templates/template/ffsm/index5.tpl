...
<section class="wrapper">
  ...
  <section class="indexBann">
    <ul class="swiper-wrapper">
        <{foreach from=$home_banner item='banner'}>
              <li class="swiper-slide"><a href="<{$banner.link}>"><img src="<{$banner.image}>" alt="<{$banner.title}>"/></a></li>
        <{/foreach}>
    </ul>
  </section>
  <!--banner-->
  ...
  <section class="bigbox">
    ...
    <div class="indexHotProd">
        <{foreach from=$home_hot item='hot'}>
                                <a href="<{$hot.link}>"><img src="<{$hot.image}>" alt="<{$hot.title}>"/><{$hot.title}></a>
        <{/foreach}>
    </div>
  </section>
  <!--本周热门-->
  ...
  <!--猜你喜欢-->
    <!--商城商品推荐-->
        ...
        <div class="box">
            <{foreach from=$home_special item='special'}>
                                    <a href="<{$special.link}>">
                <img src="<{$special.image}>" alt="<{$special.title}>">
                <{$special.title}>                <del>¥<{$special.old_price}></del>
                <i>¥<{$special.new_price}></i>
            </a>
            <{/foreach}>
                  </div>
...
<!--    --><!--    特辑推荐-->
  ...
  <section class="bigbox xiding">
    ...
    <div class="indexNewProd">
        <{foreach from=$home_recommend_jp item='rec'}>
                  <a href="<{$rec.link}>">
            <p><img src="<{$rec.image}>" alt="<{$rec.title}>"/></p>
            <dl>
              <dt>
                  <b><{$rec.title}></b>
                  <br><span><{$rec.description}></span>
                  <br><i><img src="static/picture/ce.png" alt=""/>
                      <{$rec.test_count}>人次已测算 &nbsp;&nbsp;&nbsp;&nbsp; <img src="static/picture/zan.png" alt=""/> <{$rec.rate}>好评</i>
              </dt>
              <dd>立即测算</dd>
            </dl>
          </a>
    ...
    <div class="indexNewProd" style="display:none;">
        <{foreach from=$home_recommend_xp item='rec'}>
                    <a href="<{$rec.link}>">
                <p><img src="<{$rec.image}>" alt="<{$rec.title}>"/></p>
                <dl>
                    <dt>
                        <b><{$rec.title}></b>
                        <br><span><{$rec.description}></span>
                        <br><i><img src="static/picture/ce.png" alt=""/> <{$rec.test_count}>人次已测算 &nbsp;&nbsp;&nbsp;&nbsp; <img src="static/picture/zan.png" alt=""/> <{$rec.rate}>好评</i>
                    </dt>
                    <dd>立即测算</dd>
                </dl>
            </a>
