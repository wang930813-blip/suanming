                        ...
                        <div class="upto-wrap">
                            <ul class="comment-list info-list-box">
                                <li>
                                        ...
                                        <p class="detail" lang>好像真的说的挺像的，塔罗牌真是个神奇的东西，希望能如占卜结果一般</p>
                                    </li><li>
                                        <p class="user" lang>匿名</p>
                                        <p class="detail" lang>每次都能帮我解决问题，是时候想想怎么做了</p>
                                    </li><li>
                                        <p class="user" lang>匿名</p>
                                        <p class="detail" lang>真的，没有查看深度解析的时候，看图解就已经才出来一二分，心里面有谱了，真心感谢，不是托，</p>
                                    </li><li>
                                        <p class="user" lang>匿名</p>
                                        <p class="detail" lang>希望可以成真，希望最后的最后我们能重新走到一起并走到最后</p>
                                    </li><li>
                                        <p class="user" lang>陈先生</p>
                                        <p class="detail" lang>坦白说这回答令我觉得不可思议。第一张牌就直入重点。经过详细的分析和指导我更明确下一步和每一步感恩！</p>
                                    </li><li>
                                        <p class="user" lang>方先生</p>
                                        <p class="detail" lang>我也是无意间看到这个测试的，原本只想当游戏玩玩的，没想到看测试结果贴近80%吧，还算满意</p>
                                    </li><li>
                                        <p class="user" lang>myl先生</p>
                                        <p class="detail" lang>和婚姻师说的很相像
厉害了
希望时间能解决一切
我希望大家都能成长</p>
                                    </li><li>
                                        <p class="user" lang>che先生</p>
                                        <p class="detail" lang>塔罗牌算的真的是太准了，完全说出了我们之间存在的问题，也给了我建议，我知道该怎么做了！</p>
                                    </li><li>
                                        <p class="user" lang>刁*女士</p>
                                        <p class="detail" lang>测算的内容很详细很有用，希望能帮我早日与他复合</p>
                                    </li><li>
                                        ...
                                        <p class="detail" lang>说中了95%，真的是牛皮！！！就一个字：服！
</p>
                                    </li><li>
                                        <p class="user" lang>洪*女士</p>
                                        <p class="detail" lang>内容很多，感觉都有几千字了。
</p>
                                    </li><li>
                                        <p class="user" lang>石*先生</p>
                                        <p class="detail" lang>内容上比较有针对性,也很直白。个人觉得还是蛮准的,并且很详细,很值！
</p>
                                    </li><li>
                                        ...
                                        <p class="user" lang>任*女士</p>
                                        <p class="detail" lang>太神奇了，真得好准```
</p>
                                    </li><li>
                                        <p class="user" lang>高*女士</p>
                                        <p class="detail" lang>内容有当前对方想法、存在的问题、是否能够复合，同时也有对应的化解方法，个人觉得非常实用准确，推荐！
</p>
                                    </li><li>
                                        <p class="user" lang>雷*先生</p>
                                        <p class="detail" lang>跟简介很匹配，想看的都看到了，希望能突破当前的局势，和她早日复合。
</p>
                                    </li><li>
                                        <p class="user" lang>龙*先生</p>
                                        <p class="detail" lang>分手好久了，一直没死心，感谢塔罗指引我什么才是该坚持的。
</p>
                                    </li><li>
                                        <p class="user" lang>孙*先生</p>
                                        <p class="detail" lang>我是朋友介绍过来的，没想到这么不错，女朋友已追回，感谢！
</p>
                                    </li><li>
                                        <p class="user" lang>何*女士</p>
                                        <p class="detail" lang>准！原来最近跟男朋友一直分分合合原因竟然是这样！！不说了我要赶紧去哄他了
</p>
                                    </li><li>
                                        ...
                                        <p class="detail" lang>分手半年女朋友心里还有我，这次误会解除，我一定好好跟她相处！
</p>
                                    </li><li>
                                        <p class="user" lang>吴*先生</p>
                                        <p class="detail" lang>就两个字： 超值！！！
</p>
                                    </li><li>
                                        <p class="user" lang>周*女士</p>
                                        <p class="detail" lang>跟他分分合合好几年了都没被善待，看来果然不应该再坚持了。很实用，感谢！
</p>
                                    </li><li>
                                        <p class="user" lang>秦*女士</p>
                                        <p class="detail" lang>准！比较详细，我喜欢这种比较直接的。不过有一些细节不是很深入，想找老师帮忙再详细算一遍。
</p>
                                    </li>                            </ul>
                        </div>
                    </div>
