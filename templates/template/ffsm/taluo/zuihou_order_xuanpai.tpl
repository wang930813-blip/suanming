...
<head>
    ...
    <link rel="stylesheet" href="/statics/ffsm/taluo/zuihou/watch.css?v=1.6">
...
<div class="main-content">
    ...
    <div class="ensure_box">
        <div class="ensure_card card_0">
            <div class="card-wrap flex-column">
                ...
                <div class="img-wrap">
                    <img class="ensure_img" src="/statics/ffsm/taluo/zuihou/img/cover.png">
    ...
    <div class="ensure flex-center">
        <img class="ensure_bg" src="/statics/ffsm/taluo/zuihou/img/triangle.png">
    </div>

    <!-- 描述信息 -->
    <div class="desc_text flex-column">
        <p id="desc_1" style="display: none">塔罗牌阵已准备就绪</p>
        <p id="desc_2" style="display: none">让我们来看看你和TA能走到最后吗？</p>
    </div>

    <!--  立即解牌 -->
    <div class="watch_btn flex-center">
        <img src="/statics/ffsm/taluo/zuihou/img/view_btn.png" class="view_btn" style="display: none;">
    </div>
    ...
    <script>
        ...
        // 生成牌
        for (var c = 0; c < 22; c++) {
            $(".card_list").append("<li class='move_card" + c + "'><img src='/statics/ffsm/taluo/zuihou/img/cover.png' /></li>");
            var step = -52.5+c*5;
        ...
        //牌面代表
        var tarot_sign = ["本命姻缘", "未来阻碍", "感情发展", "塔罗指引"];
        //  接值数组
        var all = [];
        // 倒计时
        var num = 0,
        ...
        function changeCard(li, arr, obj, topval, leftval, ctx, start_point) {
            ...
            if (all.length < 4) {
                ...
                all.push(item);
                $(obj).css({"top": start_point.y + "rem", "left": start_point.x+ "rem", "margin-left": "-1.2rem", "display": "block", "z-index": 9999, "transform": "translateZ(100px)", "-webkit-transform": "translateZ(100px)"});
                $(obj).show();
        ...
        $('.view_btn').click(function(){
            ...
            try{
                if(src==1230){
                    MtaH5.clickStat('zoudaozuihoub',{'lijijiepai':'true'});
                }else{
                    MtaH5.clickStat('zoudaozuihoua',{'lijijiepai':'true'});
                }
            }catch(err){
                console.log(err)
            }
            window.location.href = "/?ac=taluozuihou&oid=<{$data.oid}>&pay=1";
        });
        // 重新选牌
        $('.retry-tips').click(function () {
           window.location.href = "/?ac=taluozuihou&oid=<{$data.oid}>&update=1";
        });
    </script>
</div>
</body>
