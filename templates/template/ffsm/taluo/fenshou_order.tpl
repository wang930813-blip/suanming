                        ...
                        <div class="upto-wrap">
                            <ul class="comment-list info-list-box">
                                <li>
                                        ...
                                        <p class="detail" lang>塔罗牌算的真的是太准了，完全说出了我当前感情存在的问题，也给了我建议，我知道该怎么做了！鲁*女士</p>
                                    </li><li>
                                        <p class="user" lang>吴*先生</p>
                                        <p class="detail" lang>准确！比之前测过其他家的好很多，当下问题、状态都很对，建议也很中肯，太值了！</p>
                                    </li><li>
                                        ...
                                        <p class="detail" lang>内容很丰富，对分手与否的建议也是比较具体的。</p>
                                    </li><li>
                                        ...
                                        <p class="detail" lang>第一次用塔罗测试，本来是不太信的，但是测了两次结果都比较接近，最重要的是前天他联系我要求婚，太太太惊喜了!</p>
                                    </li><li>
                                        <p class="user" lang>张*女士</p>
                                        <p class="detail" lang>解牌马上就看出了问题的关键，说的很到位，感觉对未来不再是那么迷茫了！</p>
                                    </li><li>
                                        <p class="user" lang>魏*先生</p>
                                        <p class="detail" lang>跟简介很匹配，想看的都看到了，希望能像说的那样，通过调整在感情中不再被动！</p>
                                    </li><li>
                                        <p class="user" lang>许*先生</p>
                                        <p class="detail" lang>通过调整顺利和好！！！简直不要太开心，真的这是我做过最准的一次占卜！</p>
                                    </li><li>
                                        <p class="user" lang>冯*先生</p>
                                        <p class="detail" lang>我是朋友介绍过来的，本来以为必须得分手，没想到调节好了</p>
                                    </li><li>
                                        <p class="user" lang>沈*女士</p>
                                        <p class="detail" lang>非常有用，不仅有用还给了我很客观的建议！</p>
                                    </li><li>
                                        <p class="user" lang>许*先生</p>
                                        <p class="detail" lang>塔罗牌真是个神奇的东西，跟自身95%像了，特别是解决方法特别实用。</p>
                                    </li><li>
                                        <p class="user" lang>李*先生</p>
                                        <p class="detail" lang>好评，很专业！</p>
                                    </li><li>
                                        <p class="user" lang>陈*先生</p>
                                        <p class="detail" lang>总的感觉还是挺准确的，尤其当前的状态和建议，特别对我自己的现状。</p>
                                    </li><li>
                                        <p class="user" lang>魏*女士</p>
                                        <p class="detail" lang>特别特别有用，瞬间释然了，摆脱渣男！！</p>
                                    </li><li>
                                        <p class="user" lang>钱*女士</p>
                                        <p class="detail" lang>准！感觉自己瞬间都有方向了</p>
                                    </li>                            </ul>
                        </div>
                    </div>
                </div>
