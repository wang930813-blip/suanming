                        ...
                        <div class="upto-wrap">
                            <ul class="comment-list info-list-box">
                                <li>
                                        ...
                                        <p class="detail" lang>说的准的可怕……让我重新认识了塔罗牌的力量</p>
                                    </li><li>
                                        <p class="user" lang>匿名</p>
                                        <p class="detail" lang>确实很准，现状就是这样，存在的问题也说对了</p>
                                    </li><li>
                                        <p class="user" lang>先生</p>
                                        <p class="detail" lang>还可以，虽然现在分手了，但起码我知道了下一个的大概方向了吧。</p>
                                    </li><li>
                                        <p class="user" lang>兔先生</p>
                                        <p class="detail" lang>说的跟现状差不多，有几处解开些我正迷茫，没想到的，没给满分是指引牌较含糊，指引重点突出少，个人建议</p>
                                    </li><li>
                                        <p class="user" lang>先生</p>
                                        <p class="detail" lang>好准，正在考虑是否离婚</p>
                                    </li><li>
                                        <p class="user" lang>真先生</p>
                                        <p class="detail" lang>满精准的 很符合我们目前的状况 谢谢点拨</p>
                                    </li><li>
                                        <p class="user" lang>深先生</p>
                                        <p class="detail" lang>谢谢你，坚定我的坚持到底的决心</p>
                                    </li><li>
                                        <p class="user" lang>匿名</p>
                                        <p class="detail" lang>测到了很好的结果，自己一定跟随塔罗牌指引好好跟他走下去</p>
                                    </li><li>
                                        <p class="user" lang>欢先生</p>
                                        <p class="detail" lang>说得真的很准，塔罗牌真的能看到我的感情状态，说得也很到位，我也知道我的缺点，真心感谢????，会谨记！</p>
                                    </li><li>
                                        ...
                                        <p class="detail" lang>准到不行哦！！！以后遇到问题还会来寻求帮助的，谢谢。
</p>
                                    </li><li>
                                        ...
                                        <p class="detail" lang>一直以来对他很放心，以后会更放心了哈哈。
</p>
                                    </li><li>
                                        <p class="user" lang>李*女士</p>
                                        <p class="detail" lang>内容很丰富，很多对未来的预测和建议。
</p>
                                    </li><li>
                                        <p class="user" lang>简*先生</p>
                                        <p class="detail" lang>内容上比较有针对性,也很容易懂,不会很文绉绉的,比较直白。个人觉得还是蛮准的,并且很详细,很值！
</p>
                                    </li><li>
                                        ...
                                        <p class="detail" lang>跟简介很匹配，想看的都看到了，希望能像说的那样，跟她一起走到最后！
</p>
                                    </li><li>
                                        <p class="user" lang>许*女士</p>
                                        <p class="detail" lang>终于不用担心自己嫁不出去了哈哈哈！
</p>
                                    </li><li>
