                ...
                <div class="upto-wrap">
                    <ul class="comment-list info-list-box">
                        <li>
                                ...
                                <p class="detail" lang>感觉还是蛮准的，和男朋友目前处于这种阶段</p>
                            </li><li>
                                <p class="user" lang>匿名</p>
                                <p class="detail" lang>其实我本来只是抱着玩玩的心态来试试……没想到结果竟然出乎我意料地准……有点想哭。</p>
                            </li><li>
                                <p class="user" lang>匿名</p>
                                <p class="detail" lang>说的是我心里所希望所明白也不敢直视的，好评</p>
                            </li><li>
                                <p class="user" lang>匿名</p>
                                <p class="detail" lang>天哪…每一句都是正确的！我现在的状态就是这样！迷茫不解…真的稍有不慎，可能这段感情就会就此断送了吧</p>
                            </li><li>
                                <p class="user" lang>兔先生</p>
                                <p class="detail" lang>找到问题所在，问题所在，可以利用直觉直觉，谢谢，我知道怎么做了</p>
                            </li><li>
                                <p class="user" lang>匿名</p>
                                <p class="detail" lang>总的感觉还是挺准确的，其实有些问题自己是想到过的，只是当局者迷，需要一个外界的指引。</p>
                            </li><li>
                                <p class="user" lang>可先生</p>
                                <p class="detail" lang>真的很准，钱没有白花，一开始的时候确实很犹豫，结果真的是很准，真的很棒。</p>
                            </li><li>
                                <p class="user" lang>重先生</p>
                                <p class="detail" lang>出乎意料的准确，正好符合现状，感谢指引和协助</p>
                            </li><li>
                                <p class="user" lang>先生</p>
                                <p class="detail" lang>前面的解释真的好准！我以前也在其他占卜师占卜过，说我和她的沟通有问题，我会寻找正确的道路的！</p>
                            </li><li>
                                <p class="user" lang>裴**先生</p>
                                <p class="detail" lang>非常不错！90%准确率高！！~</p>
                            </li><li>
                                <p class="user" lang>将**先生</p>
                                <p class="detail" lang>感觉占的很准，如果还想再占一卦该从哪里进入？</p>
                            </li><li>
                                <p class="user" lang>Ang*先生</p>
                                <p class="detail" lang>塔罗牌我以前从不信，可是算了几次都蛮准的，不得不信！</p>
                            </li><li>
                                <p class="user" lang>将**先生</p>
                                <p class="detail" lang>开始是试试的态度，测了之后的确挺准的，希望我的爱情更好</p>
                            </li><li>
                                <p class="user" lang>汤**先生</p>
                                <p class="detail" lang>有些明白自己是怎么回事了，结婚这么多年没能给她想要的生活，一直让她陪我吃苦还欠下好多外债，这使我恐慌</p>
                            </li><li>
                                <p class="user" lang>刘**先生</p>
                                <p class="detail" lang>很准的。我非常满意，我会安照这牌上的指引把自己做的更好更加出色，去吸引他让他回心转意。</p>
                            </li><li>
                                <p class="user" lang>刘**先生</p>
                                <p class="detail" lang>挺准的，判断性格和情况都挺到位，有茅塞顿开的感觉，</p>
                            </li><li>
                                <p class="user" lang>汤**先生</p>
                                <p class="detail" lang>分析的很准确到位，钱没白花</p>
                            </li><li>
                                <p class="user" lang>雷**先生</p>
                                <p class="detail" lang>目前现状是这样的，的确是异地恋，有之前的人掺和进来，也就是第三者</p>
                            </li><li>
                                <p class="user" lang>孙**先生</p>
                                <p class="detail" lang>感谢您的分析！很到位！我会按照您所说的去做！</p>
                            </li><li>
                                <p class="user" lang>钱**先生</p>
                                <p class="detail" lang>太准了！以后不能看轻塔罗牌了！</p>
                            </li><li>
                                <p class="user" lang>刘**先生</p>
                                <p class="detail" lang>确实很准确，对应我现在的状况，描述的非常贴近，满意！</p>
                            </li><li>
                                <p class="user" lang>秦**先生</p>
                                <p class="detail" lang>很符合现在的状态 至少值得花这个钱</p>
                            </li><li>
                                <p class="user" lang>白先生</p>
                                <p class="detail" lang>解析到点子上了，正如解析一样暂时的离别只是为了以后的相伴，是我的跑不了。</p>
                            </li><li>
                                <p class="user" lang>豆先生</p>
                                <p class="detail" lang>其实一开始我并不认为会怎么样，也是玩玩的心态进来的，但是看了分析以后，很惊讶也很震惊，还是蛮准确的，</p>
                            </li><li>
                                <p class="user" lang>瑞先生</p>
                                <p class="detail" lang>说的的确都是内心里想表达又表现不出来的想法，很真实，</p>
                            </li><li>
                                <p class="user" lang>雪先生</p>
                                <p class="detail" lang>我相信牌会为我带来神奇的力量，一定会的！</p>
                            </li><li>
                                <p class="user" lang>裴**先生</p>
                                <p class="detail" lang>第一次用塔罗牌测试，但是结果却是非常满意，而且确实很准！</p>
                            </li><li>
                                <p class="user" lang>刘**先生</p>
                                <p class="detail" lang>各张牌都很符合现在的状况，也给出了很接近的答案。挺准</p>
                            </li><li>
                                ...
                                <p class="detail" lang>无意间点进来的，忍不住好奇心就测了。emmm…真的蛮准的，性价比很高！
</p>
                            </li><li>
                                <p class="user" lang>刘**先生</p>
                                <p class="detail" lang>解说详细，内容令人信服！
</p>
                            </li><li>
                                <p class="user" lang>洪*女士</p>
                                <p class="detail" lang>内容很多，感觉都快有1w字了。
</p>
                            </li><li>
                                <p class="user" lang>石*先生</p>
                                <p class="detail" lang>内容上比较有针对性,也很容易懂,不会很文绉绉的,比较直白。</p>
                            </li><li>
                                ...
                                <p class="detail" lang>内容有当前感情状态、原因、你内心的真实想法，同时也有对应的化解方法，个人觉得非常实用准确，推荐！
</p>
                            </li><li>
                                <p class="user" lang>雷*先生</p>
                                <p class="detail" lang>跟简介很匹配，想看的都看到了，希望能突破当前的局势，化解和她之间的矛盾。
</p>
                            </li><li>
                                <p class="user" lang>孙*先生</p>
                                <p class="detail" lang>我是朋友介绍过来的，没想到这么不错，说的很准！强烈推荐！！！非常感谢我的朋友~
</p>
                            </li><li>
                                <p class="user" lang>何*女士</p>
                                <p class="detail" lang>准！原来最近跟男朋友一直吵架的原因竟然是这样！！不说了我要赶紧去哄他了
</p>
                            </li><li>
                                <p class="user" lang>钱*先生</p>
                                <p class="detail" lang>很专业，很详细，另外再说一句！！！真得挺准```
</p>
                            </li><li>
                                <p class="user" lang>李*先生</p>
                                <p class="detail" lang>女朋友心里满满的都是我！这次误会解除，我就向她求婚！
</p>
                            </li><li>
                                <p class="user" lang>周*女士</p>
                                <p class="detail" lang>喜欢他好几年了都没被善待，看来果然不应该再坚持了。很实用，感谢！
</p>
                            </li><li>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="/?ac=member"><i class="wddd_1"></i><p>订单查询</p></a></li>
