...
<link href="/statics/ffsm/ssnvp/css/index.css" rel="stylesheet" type="text/css"/>
...
<div class="container pay" style="padding-bottom: 0;">
  <div class="wrap">
    <div class="person <{if $names.gender==1}>person_n<{else}>person_v<{/if}>">
      <div class="hd">
        <img src="<{if $names.gender==1}>/statics/ffsm/ssnvp/img/nan_toux.png<{else}>/statics/ffsm/ssnvp/img/nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name"><{$names.username}><span class="male"><img src="<{if $names.gender==1}>/statics/ffsm/ssnvp/img/male.png<{else}>/statics/ffsm/ssnvp/img/female.png<{/if}>"></span></p>
	...
	<div class="person <{if $names.gender2==1}>person_n<{else}>person_v<{/if}>">
      <div class="hd">
        <img src="<{if $names.gender2==1}>/statics/ffsm/ssnvp/img/nan_toux.png<{else}>/statics/ffsm/ssnvp/img/nv_toux.png<{/if}>"></div>
      <div class="infos">
        <p class="name"><{$names.girl_username}><span class="male"><img src="<{if $names.gender2==1}>/statics/ffsm/ssnvp/img/male.png<{else}>/statics/ffsm/ssnvp/img/female.png<{/if}>"></span></p>
	...
	<div class="public_bg_color">
			<div class="im_info_c" style="font-size: 0.3rem;">
					<p>对的缘分，花开圆满；错的缘分，只得自食其果。情缘有份，莫因一时误判，平白错过，抱憾终生！</p>
<p>“实时男女配”为你展示双方全天24小时的“精气神”数据及匹配值，高低好坏，一目了然。解锁双方属性，知晓匹配状态。TA，是你的另一半吗？<p>
				</div>
</div>
    
	<div class="public_bg_color J_testFixedShow" id="paytype">
		<div class="price">
		  <p class="tit1 left_l_bf">测算项目：实时男女配 【付费一次,可看前后6天】</p>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="?ac=ssnvp"><em><i class="lijics_1"></i></em><p>重新测算</p></a></li>
...
<{include file='./ffsm/ssnvp/footer.tpl'}>
