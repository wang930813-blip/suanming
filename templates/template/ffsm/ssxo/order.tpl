...
<link rel="stylesheet" href="/statics/ffsm/ssxo/css/style.css">

<link rel="stylesheet" href="/statics/ffsm/ssxo/css/font/iconfont.css">
<link href="/statics/ffsm/ssxo/css/wap.css" rel="stylesheet" type="text/css"/>
<link href="/statics/ffsm/ssxo/css/index.css" rel="stylesheet" type="text/css"/>
...
<a class="public_h_con" href="/?ac=ssxo">实时寻偶</a><a href="javascript:void(0)" class="public_h_menu"<{if $nologin}>  onclick="layui.use('layer', function(){layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
location.href='?ac=userlogin&return_url=<{$return_url}>';
}});});"<{else}>:class="show" @click="chooseCoupon"<{/if}> ><img src="/statics/ffsm/ssxo/img/wddd.png" /></a></div>
<div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/ssxo/img/laba.png" /></span><p class="inner"><{$gundong}></p></div>
...
<div class="container pay" style="padding-bottom: 0;">
  <div class="wrap">
	...
	<{include file='./ffsm/ssxo/ss_icon.tpl'}>
	<div class="public_bg_color">
		<div class="center_bg">
			...
			<div class="im_info">
				...
				<p>命里桃花由天赐，能否采摘看个人。莫因桃花出现之时，自己不知，平白错过！解锁自身属性，知晓魅力波动。“实时寻偶”为你展示全天24小时的“精气神”数据及桃花值，高低好坏，一目了然，辨别简单，桃花朵朵，自在掌中！</p>
					</div>
	...
	<div class="public_bg_color J_testFixedShow" id="paytype">
		<div class="price">
		  <p class="tit1 left_l_bf">测算项目：实时寻偶 【付费一次,可看前后6天】</p>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     <li><a href="?ac=ssxo"><i class="shouye_1"></i><p>测算首页</p></a></li>
     <li><a href="/?ac=member"><i class="wddd_1"></i><p>订单查询</p></a></li>
     <li><a href="?ac=ssxo"><em><i class="lijics_1"></i></em><p>重新测算</p></a></li>
...
<{include file='./ffsm/ssxo/footer.tpl'}>
