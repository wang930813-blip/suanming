...
<a class="public_h_con" href="/?ac=ssxo">实时寻偶</a><a href="javascript:void(0)" class="public_h_menu"<{if $nologin}>  onclick="layer.msg('请登陆后查看',{time: 20000,btn: ['去登陆','不了'],yes: function(index, layero){
...
<{if $gundong}><div class="alert-marquee" id="alertMarquee"><span><img src="/statics/ffsm/ssxo/img/laba.png" /></span><p class="inner"><{$gundong}></p></div><{/if}>
...
<div class="public_bg_from">
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=ssxo" name="login" method="post" onSubmit="return checkForm();">
		...
		<div class="form_bottom_txt">
			<span>已为<b>5408</b>人查看2022年实时寻偶</span>
		</div>
	</form>
...
<{include file='./ffsm/ssxo/footer_jg.tpl'}>
