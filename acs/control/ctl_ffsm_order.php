...
class ctl_ffsm_order extends common{
	...
	protected $paytype = array( 0=>'无',1=>'微信', 2=>'支付宝', 3=>'积分', 4=>'vip');
    protected $status = array(0=>'待付费',1=>'<font color="red">已付费</font>');
	protected $type = array(1=>'01、事业财运', 2=>'02、八字合婚', 3=>'03、姓名分析', 4=>'04、姓名配对', 5=>'05、紫薇命盘', 6=>'06、八字综合', 7=>'07、姻缘测算', 8=>'08、八字精批', 9=>'09、爱情运势', 10=>'10、精批PC版', 25=>'11、在线预约', 12=>'12、今年运程', 21=>'13、许愿点灯', 16=>'14、月老姻缘', 18=>'15、号码测算',23=>'16、宝宝起名',24=>'17、公司起名',26=>'18、塔罗运势',27=>'19、塔罗暗恋',28=>'20、塔罗心里',29=>'21、塔罗继续',30=>'22、塔罗爱情',31=>'23、塔罗脱单',32=>'24、塔罗复合',33=>'25、塔罗最后',34=>'26、塔罗分手',35=>'27、塔罗别人',37=>'28、星座运势',38=>'30、塔罗问答',36=>'29、等待开发',301=>'实时财运');
    public function __construct()
    {
        ...
        $url=db::queryone("SELECT * FROM `system` WHERE `name` = 'smurl'");



        tpl::assign('web_title', $url);
        tpl::assign('url',$http_type . $url['config']);
	...
	public function excel_out(){
     	...
     	$arrtype=array(1=>'事业财运', 2=>'八字合婚', 3=>'姓名分析', 4=>'姓名配对', 5=>'紫薇命盘', 6=>'八字综合', 7=>'姻缘测算', 8=>'八字精批', 9=>'爱情运势', 10=>'精批PC版', 25=>'在线预约', 12=>'今年运程', 21=>'许愿点灯', 16=>'月老姻缘', 18=>'号码测算',23=>'宝宝起名',24=>'公司起名',26=>'塔罗运势',27=>'塔罗暗恋',28=>'塔罗心里',29=>'塔罗继续',30=>'塔罗爱情',31=>'塔罗脱单',32=>'塔罗复合',33=>'塔罗最后',34=>'塔罗分手',35=>'塔罗别人',36=>'星座星盘',37=>'星座运势',38=>'塔罗问答');
