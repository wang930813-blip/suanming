...
class ctl_users
{
    ...
    */
    public function index()
    {
      ...
      if(req::item('sch_phone')){
        ...
        // 指定要查询的字段（包含mobile）
        $tb->list_config['fields'] = 'uid,sd_uid,user_name,mobile,nickname as user_nicheng,class as user_dl_mode,integral as jf,dl_tcbl,dl_money1 as money,dl_money2 as moneys';
        
        $tb->set_tplfiles('users.index.html', 'users.add.html', 'users.edit.html'); //手工指定生成的模板名 $tpl_files:array('list'=>'', 'add'=>'', 'edit'=>'');
        /*
         * print_r(req::$forms);
    ...
    */
    public function editpwd()
    {
        ...
        $tb->set_tplfiles('', '', 'users.edit.me.html');
        $tb->listen(req::$forms);
    ...
    */
    public function edit_purview_groups()
    {
        ...
        tpl::display('users.edit_purview_groups.html');
        exit();
    }
    ...
    */
    public function log()
    {
        ...
        $tb->set_tplfiles('users.log.html', '', '');
        $tb->listen(req::$forms);
        exit();
    }
    ...
    */
    public function login_log()
    {
        ...
        $tb->set_tplfiles('users.login_log.html', '', 'users.login_log.edit.html');
        $tb->listen(req::$forms);
        exit();
    }
    ...
    */
    public function edit_purview_xml()
    {
        ...
        if( empty($purview_xml) )
        {
            ...
            tpl::display('users.edit_purview_xml.html');
        }
        else
        {
