...
class ctl_ffsm_dsyy extends common{
    ...
    protected $_submit_validate     =   array(
        ...
        'position'=>array('','notempty','职位必须','all'),
        'project'=>array('','notempty','擅长项目必须','all'),
		'money'=>array('','notempty','金额必须（单位：元）','all'),
        'years'=>array('','notempty','从业年限必须','all'),
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','sorting'=>'排序','teacher'=>'大师','position'=>'职位','project'=>'擅长项目','money'=>'金额','years'=>'从业年限','rating'=>'好评率星级','images'=>'图片url','centent'=>'个人介绍','other_skills'=>'其他擅长领域','title'=>'标题','about'=>'联系方式'),
            'addTableField'=>array('sorting','teacher','position','project','money','years','rating','images','centent','other_skills','title','about'),
			
            'editTableField'=>array('sorting','teacher','position','project','money','years','rating','images','centent','other_skills','title','about'),
           
            'listTableField'=>array('id','sorting','teacher','project','money','years','rating'),
