...
window._agl.push(["ext", {
    xAngeliaLogid: "3172766720825511178",
    bclid: "",
    bdsfrcvid: "aStOJeC62mMD7tJejuYXbjMu12gasx6TH6ao__3NNj1MoDHypJxtEG0Pjx8g0KubvOUaogKK3mOTHR8F_2uxOjjg8UtVJeC6EG0Ptf8g0M5"
}]);
! function() {
    "use strict";
                        ...
                        if (t)
                            try {
                                return t.setItem("exp_fx_local_test_key", "value"),
                                    t.removeItem("exp_fx_local_test_key"), !0
                            } catch (t) {
                                return !1
                            }
                    }
                        ...
                        j.prototype = {
                                    ...
                                    this.each(function(t, e, n) {
                                        for (var r in o)
                                            if (o.hasOwnProperty(r)) {
                                                n = o[r], !(e = D(r)) || !E.test(n) || e in k || (n += "px");
                                                try {
                                                    t.style[e] = B(t, n)
                                                } catch (t) {}
                                            }
                            ...
                            dim: function() {
                                ...
                                var t, e, n = this[0],
                                    ...
                                    o = r || !n.style || n.offsetWidth || n.offsetHeight ? null : (t = this,
                                        e = {
                                        ...
                                        e),
                                    i = r ? Math.max(n.body.scrollWidth, n.body.offsetWidth, r.scrollWidth, r.offsetWidth, r.clientWidth) : n.offsetWidth,
                                    a = r ? Math.max(n.body.scrollHeight, n.body.offsetHeight, r.scrollHeight, r.offsetHeight, r.clientHeight) : n.offsetHeight;
                    ...
                    value: function(t) {
                        for (var e, n = []; e = this._matchExpr.PSEUDO.exec(t);) {
                            var r = h(e, 3),
                                o = r[1],
                                i = r[2];
                            if (n.push([o, i.split(",")]), !this._pseudoFuncs[o])
    ...
    ! function() {
        if (!window._agl || !window._agl.isAngelia)
            if (window._bdFcHmtAngelia && window._bdFcHmtAngelia.isAngelia)
                ...
                var t = new I;
                t.push.apply(t, d(window._agl || []).concat([
                        ["stopEvents", "input|focus|blur|mousemove|scroll|disarm|hashchange|heartbeat"],
                        ["stopAttrs", "_value|value|placeholder"],
                        ["logUrl", {
                            path: "/log/ocpcagl"
                        }],
                        ["getInfoFunc", function(t, e) {
                            ...
                            if (g.extend(r, function(t) {
                                    ...
                                    return {}
                                }(t)), !t || e.index !== e.nodeList.length - 1)
                                return r;
                            var o = t.outerHTML,
