...
requirejs.config({
	...
	}), $(".Js_date1").length > 0 && require(["ffsm.datepicker", "css!/statics/ffsm/public/js/chenrf/rui-datepicker.min.css"], function() {
		for (var e = 0, a = $(".Js_date1").length; e < a; e++) {
			(new ruiDatepicker).init("#" + $(".Js_date1").eq(e).attr("id"))
		}
	}), $(".Js_date2").length > 0 && require(["ffsm.datepicker", "css!/statics/ffsm/public/js/chenrf/rui-datepicker.min.css"], function() {
		for (var e = 0, a = $(".Js_date2").length; e < a; e++) {
			(new ruiDatepicker).init("#" + $(".Js_date2").eq(e).attr("id"))
		}
	}), $(".Js_date3").length > 0 && require(["ffsm.datepicker", "css!/statics/ffsm/public/js/chenrf/rui-datepicker.min.css"], function() {
		for (var e = 0, a = $(".Js_date3").length; e < a; e++) {
			(new ruiDatepicker).init("#" + $(".Js_date3").eq(e).attr("id"))
		}
	}), $(".Js_date4").length > 0 && require(["ffsm.datepicker", "css!/statics/ffsm/public/js/chenrf/rui-datepicker.min.css"], function() {
		for (var e = 0, a = $(".Js_date4").length; e < a; e++) {
			(new ruiDatepicker).init("#" + $(".Js_date4").eq(e).attr("id"))
		}
	}), $(".Js_date5").length > 0 && require(["ffsm.datepicker", "css!/statics/ffsm/public/js/chenrf/rui-datepicker.min.css"], function() {
		for (var e = 0, a = $(".Js_date5").length; e < a; e++) {
			(new ruiDatepicker).init("#" + $(".Js_date5").eq(e).attr("id"))
		}
	}), $(".Js_date6").length > 0 && require(["ffsm.datepicker", "css!/statics/ffsm/public/js/chenrf/rui-datepicker.min.css"], function() {
		for (var e = 0, a = $(".Js_date6").length; e < a; e++) {
			(new ruiDatepicker).init("#" + $(".Js_date6").eq(e).attr("id"))
		}
	}), $(".Js_date7").length > 0 && require(["ffsm.datepicker", "css!/statics/ffsm/public/js/chenrf/rui-datepicker.min.css"], function() {
		for (var e = 0, a = $(".Js_date7").length; e < a; e++) {
			(new ruiDatepicker).init("#" + $(".Js_date7").eq(e).attr("id"))
		}
	}), $(".Js_date8").length > 0 && require(["ffsm.datepicker", "css!/statics/ffsm/public/js/chenrf/rui-datepicker.min.css"], function() {
		for (var e = 0, a = $(".Js_date8").length; e < a; e++) {
			(new ruiDatepicker).init("#" + $(".Js_date8").eq(e).attr("id"))
		}
	}), $(".Js_date9").length > 0 && require(["ffsm.datepicker", "css!/statics/ffsm/public/js/chenrf/rui-datepicker.min.css"], function() {
		for (var e = 0, a = $(".Js_date9").length; e < a; e++) {
			(new ruiDatepicker).init("#" + $(".Js_date9").eq(e).attr("id"))
		}
	}), $(".Js_date10").length > 0 && require(["ffsm.datepicker", "css!/statics/ffsm/public/js/chenrf/rui-datepicker.min.css"], function() {
		for (var e = 0, a = $(".Js_date10").length; e < a; e++) {
			(new ruiDatepicker).init("#" + $(".Js_date10").eq(e).attr("id"))
		}
	}), $(".Js_date_zs").length > 0 && require(["ffsm.datepicker", "css!/statics/ffsm/public/js/chenrf/rui-datepicker-zs.min.css"], function() {
		for (var e = 0, a = $(".Js_date_zs").length; e < a; e++) {
			(new ruiDatepicker).init("#" + $(".Js_date_zs").eq(e).attr("id"))
		}
