<?php
    // 🔴 修复：注释掉远程用户中心配置（该功能未使用，且会向 zhankey.com 发送用户数据）
    // 本地登录使用 cls_access，不依赖此配置
    /*
    define('MYAPI_URL_MY', 'http://www.zhankey.com');               //  用户中心网址
    define('MYAPI_URL_PASSPORT',"http://www.zhankey.com");    //  PASSPORT 网址
