...
require CORE.'/library/cls_lunar_calendar.php';

$cts_arr=array('h5_index','ffsm_index','ffsm_h5_index','ffsm_sm_ssys','ffsm_sm_ssxo','ffsm_sm_ssjf','ffsm_sm_ssjs','ffsm_sm_ssjk','ffsm_sm_ssjj','ffsm_sm_sslg','ffsm_sm_ssnvp','ffsm_sm_ssnnp','ffsm_sm_ssvvp','ffsm_sm_sscwy','ffsm_sm_sssx','shop');
...
//免费版表单增加按钮链接到付费测算
// 🔴 修复：去除指向 zhankey.com 的引流链接，改为空（按钮将不显示）
$GLOBALS['config']['ff_url']['bazijp']="";
$GLOBALS['config']['ff_url']['bazijp_t']="付费测算";
$GLOBALS['config']['ff_url']['hehun']="";
$GLOBALS['config']['ff_url']['hehun_t']="付费测算";
$GLOBALS['config']['ff_url']['xmpd']="";
$GLOBALS['config']['ff_url']['xmpd_t']="付费测算";
$GLOBALS['config']['ff_url']['ffqm']="";
$GLOBALS['config']['ff_url']['ffqm_t']="付费测算";
$GLOBALS['config']['ff_url']['xmfx']="";
$GLOBALS['config']['ff_url']['xmfx_t']="付费测算";
$GLOBALS['config']['ff_url']['bazi']="";
$GLOBALS['config']['ff_url']['bazi_t']="付费测算";
$GLOBALS['config']['ff_url']['hmjx']="";
$GLOBALS['config']['ff_url']['hmjx_t']="付费测算";
tpl::assign('ff_url',$GLOBALS['config']['ff_url']);

$page_meta = '';
// 🔴 修复：禁止从数据库加载远程授权验证脚本（防止域名验证弹窗）
// 原代码从 system_config_cache 读取，可能包含远程 auth.js，屏蔽之
/*
$meta_sql = "SELECT cache_data FROM system_config_cache WHERE cache_key = 'sys_config' AND cache_status = 1 LIMIT 1";
$meta_row = db::querylist($meta_sql);
if (!empty($meta_row[0]['cache_data'])) {
    $page_meta = $meta_row[0]['cache_data'];
}
*/
